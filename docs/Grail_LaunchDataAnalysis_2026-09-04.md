...
† Sep 9 anchor = **287 exact** (dual-sample totals at 03:32 UTC, zero Sep-9 reviews existed before 04:38 UTC): day-8 final intake is therefore **20** (267 + 20), one more than the 19 first chained from cache-gapped lists. Sep 10 anchor = 287 + day-9 intake 9.

‡ Sep 11–13 anchors corrected on 2026-09-13: the first pass (written Sep 12) mis-derived the UTC day boundaries (off by ~4 h → day-10/day-11 first reported as 17/11). Correct full-day closures from raw timestamps: **day-10 (Sep 10) = 20, day-11 (Sep 11) = 9, day-12 (Sep 12) = 15**, and the chain closes exactly: 296 + 20 + 9 = 325 (Sep 12 00:00), + 15 = 340 = observed totals (Sep 13 03:21, whose newest review is Sep 12 21:34 — the appreviews edge cache was ~6 h stale at sampling). Raw point-in-time readings now: … 287 @ Sep 9 03:32 · 299 @ Sep 10 02:56 · 327 @ Sep 12 05:55 · 340 @ Sep 13 03:21. Standing lessons: (1) partial-day rates are recorded as observations only, never chained forward; (2) UTC day boundaries must come from a script (`1788220800 + N·86400` from the verified Sep 1 00:00 epoch), never from mental date arithmetic.
...
- **2026-09-18**: if the daily rate has dropped below ~15/day, month-1 settles toward the lower band (~450 reviews).
	...
	- *Status 2026-09-12 (interim, 05:55 UTC)*: *(day counts corrected 2026-09-13 — see the ‡ footnote in §2: day-10 = 20, day-11 = 9, not 17/11)* floor band is noisy at 9–20/day, not a monotone decay. Negatives 25 → 28 (+3: genre-fit "not got the sauce", a first-ever *update-blame* negative alleging post-launch nerfs "ruined the fun from the demo" and calling the game punitive, plus one uncaptured). Watch item: CCU 325 @ 05:55 UTC is an off-anchor reading (05:55 vs the 02–03 UTC comparable block); US-prime sample on Sep 13 will tell whether the d9–d10 plateau (468/465) broke. First czech review in the language mix.

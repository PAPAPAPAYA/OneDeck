...
public class CardManipulationEffect : MonoBehaviour
{
	...
	public void StageSelf() // put self on top of the deck
	{
		...
		CombatInfoDisplayer.me.effectResultDisplay.text += "["+_myCardScript.cardName+"] is staged to the top of the deck\n";
	}
	...
	public void BurySelf() // put self at the bottom of the deck
	{
		...
		CombatInfoDisplayer.me.effectResultDisplay.text += "["+_myCardScript.cardName+"] is buried to the bottom of the deck\n";
	}
}
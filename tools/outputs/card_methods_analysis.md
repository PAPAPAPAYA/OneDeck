...
- **[揭晓时] → 造成 {N}伤害**  —— 使用卡片：AVENGER, BLACKSMITH, COFFIN_MAKER, CURSE_THIRST_BEAST, GOBLIN_ASSASSIN_TEAM, GOBLIN_CHARGE_TEAM, GRAVE_INVITATION, GRAVE_KEEPER, POISONER, POWER_CRAVER, POWER_SURGE, RIFT_DEVOURER, RIFT_DRAGON, RIFT_INSECT, RIFT_MONSTER, SLIME, SNATCHER, SOLDIER_SKELETON, SPIKE_SKELETON, TACTICAL_BREACHER, THE_FOOL, UNFINISHED_ROBOT
- **[揭晓时] → 埋葬 {N}友方**  —— 使用卡片：BOOSTER, CONFUSED_PORTALMANCER, CORPSE_CANON, GRAVE_PUNCH, GRAVE_TOGETHER, SACRIFICE_RITUAL, SACRIFICIAL_CURSE, UNSTABLE_PORTAL
- **[揭晓时] → 埋葬 {N}敌方**  —— 使用卡片：ANTI_CREATURE_WEAPON, COFFIN_MAKER, DR_MANHATTAN, FALL_INTO_RIFT, GRAVE_PORTAL, GRAVE_TOGETHER, RIFT_GUIDE
- **[揭晓时] → 置顶 {N}友方**  —— 使用卡片：CURSE_SUMMONER, CURSE_THIRST_SUMMONER, DR_MANHATTAN, RIFT_SUMMONER, SIDE_EFFECT_PORTAL, UNSTABLE_PORTAL
- **[揭晓时] → 增强 {N}敌方[诅咒]**  —— 使用卡片：CURSED_CORPSE, POISONER, RIFT_CURSE, SACRIFICIAL_CURSE, SMALL_SCALE_DEATH
- **[揭晓时] → 生成 {N}[次元裂缝]**  —— 使用卡片：FALL_INTO_RIFT, RIFT_CURSE, RIFT_DRAGON, SACRIFICE_RITUAL
- **[揭晓时] → 给予下{X}卡 {N}力量**  —— 使用卡片：BLIND_COMBAT_PRIEST, CURSE_THIRST_SUMMONER, MAD_SCIENTIST
- **[揭晓时] → 去除 {N}[次元裂缝]**  —— 使用卡片：RIFT_GUIDE, RIFT_MONSTER, RIFT_SUMMONER
- **[揭晓时] → 消耗敌方[诅咒] {N}力量**  —— 使用卡片：CURSE_SUMMONER, CURSE_THIRST_SUMMONER
...
- **[揭晓时 | 敌方[诅咒]每有 {N} 力量;敌方[诅咒]每有 {N} 力量] → 给予 {N}友方 {N}力量**  —— 使用卡片：CURSE_THIRST_SHAMAN
- **[揭晓时 | 敌方[诅咒]每有 {N} 力量;敌方[诅咒]每有 {N} 力量] → 增强 {N}敌方[诅咒]**  —— 使用卡片：DETERIORATION
- **[揭晓时] → 消耗 {N}力量**  —— 使用卡片：DR_MANHATTAN
...
- **[揭晓时] → 敌方[诅咒]力量 - {N}**  —— 使用卡片：PREMATURE
- **[揭晓时] → 置顶敌方[诅咒]**  —— 使用卡片：PREMATURE
- **[揭晓时] → 复制敌方 {N}[诅咒]**  —— 使用卡片：PROLIFERATING_CURSE
- **[揭晓] → 埋葬 {N}友方**  —— 使用卡片：SACRIFICIAL_SWORD
- **[揭晓] → 给予 {N}友方 {N}力量**  —— 使用卡片：SACRIFICIAL_SWORD
...
- **[揭晓**2<counter>** 次] → 造成 {N}伤害**  —— 使用卡片：ALMIGHTY
- **[揭晓**2<counter>** 次] → 置顶 {N}友方**  —— 使用卡片：ALMIGHTY
- **[揭晓**2<counter>** 次] → 埋葬 {N}敌方**  —— 使用卡片：ALMIGHTY
- **[揭晓**2<counter>** 次] → 给予 {N}友方力量**  —— 使用卡片：ALMIGHTY
- **[揭晓**2<counter>** 次] → 生成 {N}[次元裂缝]**  —— 使用卡片：ALMIGHTY
- **[揭晓**2<counter>** 次] → 增强 {N}敌方[诅咒]**  —— 使用卡片：ALMIGHTY
- **[揭晓时 | 墓地每有一个友方;墓地每有一个友方] → 埋葬所有友方**  —— 使用卡片：BODY_CANON
- **[揭晓时 | 墓地每有一个友方;墓地每有一个友方] → 造成 {N}次 {N}伤害**  —— 使用卡片：BODY_CANON
- **[揭晓时 | 墓地每有 {N} 友方;墓地每有 {N} 友方] → 增强 {N}敌方[诅咒]**  —— 使用卡片：CURSED_SKELETON
- **[揭晓时 | 本回合每置顶过 {N} 友方;本回合每置顶过 {N} 友方] → 给予 {N}友方 {N}力量**  —— 使用卡片：ELDER_SORCERER

### 无触发（系统效果）（3 种模板）

- **[] → 卡位增加 {N}**  —— 使用卡片：IncreaseDeckSize, IncreaseDeckSizeLite
- **[] → 生命值上限增加 {N}**  —— 使用卡片：IncreaseHpMax
- **[] → 生成 {N}[次元裂缝]**  —— 使用卡片：RIFT_INSECT

## 二、按动词分类的方法

### 造成（13 种模板）

- [揭晓时] → 造成 {N}伤害  —— AVENGER, BLACKSMITH, COFFIN_MAKER, CURSE_THIRST_BEAST, GOBLIN_ASSASSIN_TEAM 等
- [揭晓时] → 造成 {N}伤害 x {N}  —— GRAVE_PUNCH, POWER_SIPHONER
- [揭晓时] → 造成所有卡的力量数量的伤害  —— ALL_FOR_ONE
- [揭晓**2<counter>** 次] → 造成 {N}伤害  —— ALMIGHTY
- [揭晓时 | 墓地每有一个友方;墓地每有一个友方] → 造成 {N}次 {N}伤害  —— BODY_CANON
...
- [揭晓时] → 置顶 {N}友方  —— CURSE_SUMMONER, CURSE_THIRST_SUMMONER, DR_MANHATTAN, RIFT_SUMMONER, SIDE_EFFECT_PORTAL 等
- [被埋葬] → 置顶 {N}友方  —— GRAVE_PORTAL, SCAPEGOAT
- [每揭晓 **2<counter>** 次] → 置顶 {N}友方  —— ADVANCE_PORTAL
- [揭晓**2<counter>** 次] → 置顶 {N}友方  —— ALMIGHTY
- [洗牌后] → 置顶 {N}友方  —— BOOSTER
...
- [揭晓时] → 埋葬 {N}敌方  —— ANTI_CREATURE_WEAPON, COFFIN_MAKER, DR_MANHATTAN, FALL_INTO_RIFT, GRAVE_PORTAL 等
- [揭晓时] → 埋葬后{X}卡  —— LARGE_SCALE_DEATH, SMALL_SCALE_DEATH
- [揭晓**2<counter>** 次] → 埋葬 {N}敌方  —— ALMIGHTY
- [揭晓时 | 墓地每有一个友方;墓地每有一个友方] → 埋葬所有友方  —— BODY_CANON
- [被置顶] → 埋葬 {N}敌方  —— GOBLIN_ASSASSIN_TEAM
- [当友方被去除时] → 埋葬 {N}敌方  —— RIFT_COFFIN
- [揭晓] → 埋葬 {N}友方  —— SACRIFICIAL_SWORD
...
- [揭晓**2<counter>** 次] → 给予 {N}友方力量  —— ALMIGHTY
- [揭晓时] → 给予一个友方 {N}力量  —— BLACKSMITH
- [揭晓时 | 敌方[诅咒]每有 {N} 力量;敌方[诅咒]每有 {N} 力量] → 给予 {N}友方 {N}力量  —— CURSE_THIRST_SHAMAN
- [揭晓时 | 本回合每置顶过 {N} 友方;本回合每置顶过 {N} 友方] → 给予 {N}友方 {N}力量  —— ELDER_SORCERER
- [被置顶] → 给予 {N}友方 {N}力量  —— POWER_SURGE
- [揭晓时] → 给予友方 {N}力量 {N}次  —— POWER_TRANSFER
- [揭晓] → 给予 {N}友方 {N}力量  —— SACRIFICIAL_SWORD
- [当友方获得力量时] → 给予该友方 {N}力量  —— WEAPON_SPIRIT

### 增强（8 种模板）

- [揭晓时] → 增强 {N}敌方[诅咒]  —— CURSED_CORPSE, POISONER, RIFT_CURSE, SACRIFICIAL_CURSE, SMALL_SCALE_DEATH
- [揭晓**2<counter>** 次] → 增强 {N}敌方[诅咒]  —— ALMIGHTY
- [揭晓时 | 墓地每有 {N} 友方;墓地每有 {N} 友方] → 增强 {N}敌方[诅咒]  —— CURSED_SKELETON
- [当敌人受到伤害时] → 增强 {N}敌方[诅咒]  —— CURSE_ENCHANTMENT
- [揭晓时 | 敌方[诅咒]每有 {N} 力量;敌方[诅咒]每有 {N} 力量] → 增强 {N}敌方[诅咒]  —— DETERIORATION
...
- [揭晓时] → 敌方[诅咒]力量 - {N}  —— PREMATURE

### 生成（5 种模板）

- [揭晓时] → 生成 {N}[次元裂缝]  —— FALL_INTO_RIFT, RIFT_CURSE, RIFT_DRAGON, SACRIFICE_RITUAL
- [揭晓**2<counter>** 次] → 生成 {N}[次元裂缝]  —— ALMIGHTY
- [被埋葬] → 生成 {N}[次元裂缝]  —— CONFUSED_PORTALMANCER
- [被置顶] → 生成 {N}[次元裂缝]  —— RIFT_DRAGON
- [] → 生成 {N}[次元裂缝]  —— RIFT_INSECT
...
- [揭晓时] → 去除 {N}[次元裂缝]  —— RIFT_GUIDE, RIFT_MONSTER, RIFT_SUMMONER
- [揭晓时] → 去除 {N}敌方 {N}力量  —— POWER_TRANSFER

### 消耗（2 种模板）

- [揭晓时] → 消耗敌方[诅咒] {N}力量  —— CURSE_SUMMONER, CURSE_THIRST_SUMMONER
- [揭晓时] → 消耗 {N}力量  —— DR_MANHATTAN

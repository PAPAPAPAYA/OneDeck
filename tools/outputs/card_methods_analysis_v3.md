...
- **[揭晓时] → 造成 {N}伤害**  —— 使用卡片：ALMIGHTY, AVENGER, BLACKSMITH, COFFIN_MAKER, CURSE_THIRST_BEAST, GOBLIN_ASSASSIN_TEAM, GOBLIN_CHARGE_TEAM, GRAVE_INVITATION, GRAVE_KEEPER, POISONER, POWER_CRAVER, POWER_SURGE, RIFT_DEVOURER, RIFT_DRAGON, RIFT_INSECT, SLIME, SNATCHER, SOLDIER_SKELETON, SPIKE_SKELETON, TACTICAL_BREACHER, THE_FOOL, UNFINISHED_ROBOT
...
- **[揭晓时] → 埋葬 {N}敌方**  —— 使用卡片：ALMIGHTY, ANTI_CREATURE_WEAPON, COFFIN_MAKER, FALL_INTO_RIFT, GRAVE_PORTAL, GRAVE_TOGETHER
...
- **[揭晓时] → 置顶 {N}友方**  —— 使用卡片：ALMIGHTY, SIDE_EFFECT_PORTAL, UNSTABLE_PORTAL
- **[揭晓时] → 给予下{X}卡 {N}力量**  —— 使用卡片：BLIND_COMBAT_PRIEST, CURSE_THIRST_SUMMONER, MAD_SCIENTIST
- **[揭晓时 | 消耗敌方[诅咒] **1** 力量] → 置顶 {N}友方**  —— 使用卡片：CURSE_SUMMONER, CURSE_THIRST_SUMMONER
...
- **[揭晓时 | 消耗 **3** 力量] → 置顶 {N}友方**  —— 使用卡片：DR_MANHATTAN
- **[揭晓时 | 消耗 **3** 力量] → 埋葬 {N}敌方**  —— 使用卡片：DR_MANHATTAN
...
- **[揭晓时 | 去除 **1** [次元裂缝]] → 埋葬 {N}敌方**  —— 使用卡片：RIFT_GUIDE
- **[揭晓时 | 去除 **1** [次元裂缝]] → 造成 {N}伤害**  —— 使用卡片：RIFT_MONSTER
- **[揭晓时 | 去除 **1** [次元裂缝]] → 置顶 {N}友方**  —— 使用卡片：RIFT_SUMMONER
...
- [揭晓时] → 置顶 {N}友方  —— ALMIGHTY, SIDE_EFFECT_PORTAL, UNSTABLE_PORTAL
- [揭晓时 | 消耗敌方[诅咒] **1** 力量] → 置顶 {N}友方  —— CURSE_SUMMONER, CURSE_THIRST_SUMMONER
- [被埋葬] → 置顶 {N}友方  —— GRAVE_PORTAL, SCAPEGOAT
- [每揭晓**2<counter>**次] → 置顶 {N}友方  —— ADVANCE_PORTAL
- [洗牌后] → 置顶 {N}友方  —— BOOSTER
- [当敌方[诅咒]揭晓时] → 置顶自身  —— CURSE_THIRST_BEAST
- [揭晓时 | 消耗 **3** 力量] → 置顶 {N}友方  —— DR_MANHATTAN
...
- [揭晓时 | 去除 **1** [次元裂缝]] → 置顶 {N}友方  —— RIFT_SUMMONER
...
- [揭晓时 | 去除 **1** [次元裂缝]] → 造成 {N}伤害  —— RIFT_MONSTER
...
- [揭晓时] → 埋葬 {N}敌方  —— ALMIGHTY, ANTI_CREATURE_WEAPON, COFFIN_MAKER, FALL_INTO_RIFT, GRAVE_PORTAL 等
- [揭晓时] → 埋葬后{X}卡  —— LARGE_SCALE_DEATH, SMALL_SCALE_DEATH
- [揭晓时 | 消耗 **3** 力量] → 埋葬 {N}敌方  —— DR_MANHATTAN
- [被置顶] → 埋葬 {N}敌方  —— GOBLIN_ASSASSIN_TEAM
- [当友方被去除时] → 埋葬 {N}敌方  —— RIFT_COFFIN
- [揭晓时 | 去除 **1** [次元裂缝]] → 埋葬 {N}敌方  —— RIFT_GUIDE

"""Create the finisher design research doc as a Notion page under the OD page.
Reads docs/ThreeGames_Finisher_Research.md, converts markdown to Notion
blocks (headings / quotes / lists / tables), creates the page and appends
children in batches. Token via env NOTION_TOKEN."""
...
DOC = r"D:/Unity Projects/OneDeck/docs/ThreeGames_Finisher_Research.md"
PARENT = "333827b8-c3c1-80fa-9bae-eb547a15270d"  # OD page
TITLE = "三款主流卡牌游戏的终端设计调研（游戏王 / 炉石传说 / 万智牌）"

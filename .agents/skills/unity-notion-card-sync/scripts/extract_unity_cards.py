"""Extract card configs from OneDeck card prefabs into JSON.

Reads every .prefab under Assets/Prefabs/Cards/3.0 no cost (current),
skipping _DONT INCLUDE and _UTILITY, and dumps file name, displayName,
...
CARD_ROOT = os.path.join("Assets", "Prefabs", "Cards", "3.0 no cost (current)")
EXCLUDE_MARKERS = ("_DONT INCLUDE", "_UTILITY")
